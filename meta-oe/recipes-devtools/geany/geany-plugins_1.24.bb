...
LIC_FILES_CHKSUM = " \
	...
	file://gproject/COPYING;md5=c107cf754550e65755c42985a5d4e9c9 \
...
SRC_URI = " \
    ...
    file://0001-Use-single-geanyplugin.h-that-provides-everything-ne.patch \
"
SRC_URI[md5sum] = "5ac59e2693bf61d4df94892aeddbd13e"
SRC_URI[sha256sum] = "dcc0414b29ae0160fc3a7adb0a1d6cbd5bd6bfb1900dab03e8774b3cebf6f2ec"
...
PLUGINS += "${PN}-gproject"
FILES_${PN}-gproject = "${libdir}/geany/gproject.so ${datadir}/icons/hicolor/16x16/apps/gproject-*.png"
RDEPENDS_${PN}-gproject = "${PN}"
